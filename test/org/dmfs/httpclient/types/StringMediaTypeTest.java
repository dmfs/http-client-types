...
public class StringMediaTypeTest
{
	...
	{
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StringMediaType("Application/XML").hashCode());
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StringMediaType("Application/XML; charset=\"utf-8\"").hashCode());
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StringMediaType("application/xml").hashCode());
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StringMediaType("application/xml; charset=\"utf-8\"").hashCode());
	}
	...
	{
		assertEquals("latin-1", new StringMediaType("Application/xml").firstParameter(Parameters.CHARSET, "latin-1").value());
		assertEquals("UTF-8", new StringMediaType("Application/xml; charset=\"UTF-8\"").firstParameter(Parameters.CHARSET, "latin-1").value());
		assertEquals("UTF-8", new StringMediaType("Application/xml; charset=\"UTF-8\"").firstParameter(Parameters.CHARSET, "UTF-8").value());
	}
	...
	public void testParameters()
	{
		...
		Iterator<Parameter<String>> iterator2 = new StringMediaType("Application/xml; charset=\"UTF-8\"").parameters(Parameters.CHARSET);
		assertTrue(iterator2.hasNext());
		assertEquals("UTF-8", iterator2.next().value());
		assertFalse(iterator2.hasNext());

		Iterator<Parameter<String>> iterator3 = new StringMediaType("Application/xml ; charset=\"UTF-8\" ; title=\"someTitle\";charset=\"latin-1\"")
	...
	public void testHasParameter()
	{
		...
		assertTrue(new StringMediaType("Application/xml; x-foo=abcde; charset=\"UTF-8\"; x-bar=1234").hasParameter(Parameters.CHARSET));
	}
	...
	public void testToString()
	{
		...
		assertEquals("Application/xml; charset=\"UTF-8\"", new StringMediaType("Application/xml; charset=\"UTF-8\"").toString());
	}
	...
	public void testEqualsObject()
	{
		...
		assertTrue(new StringMediaType("application/xml").equals(new StringMediaType("application/xml; charset=\"UTF-8\"")));
		assertTrue(new StringMediaType("application/xml").equals(new StringMediaType("Application/xml; charset=\"UTF-8\"")));
