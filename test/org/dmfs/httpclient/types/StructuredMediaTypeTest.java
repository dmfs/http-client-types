...
public class StructuredMediaTypeTest
{
	...
	{
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StructuredMediaType("Application", "XML").hashCode());
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StructuredMediaType("Application", "XML", "utf-8").hashCode());
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StructuredMediaType("application", "xml").hashCode());
		assertEquals("application".hashCode() * 31 + "xml".hashCode(), new StructuredMediaType("application", "xml", "utf-8").hashCode());
	}
	...
	{
		assertEquals("latin-1", new StructuredMediaType("Application", "xml").firstParameter(Parameters.CHARSET, "latin-1").value());
		assertEquals("UTF-8", new StructuredMediaType("Application", "xml", "UTF-8").firstParameter(Parameters.CHARSET, "latin-1").value());
		assertEquals("UTF-8", new StructuredMediaType("Application", "xml", "UTF-8").firstParameter(Parameters.CHARSET, "UTF-8").value());
	}
	...
	{
		Iterator<Parameter<String>> iterator1 = new StructuredMediaType("Application", "xml").parameters(Parameters.TITLE);
		assertFalse(iterator1.hasNext());

		Iterator<Parameter<String>> iterator2 = new StructuredMediaType("Application", "xml", "UTF-8").parameters(Parameters.CHARSET);
		assertTrue(iterator2.hasNext());
		assertEquals("UTF-8", iterator2.next().value());
		assertFalse(iterator2.hasNext());

		Iterator<Parameter<String>> iterator3 = new StructuredMediaType("Application", "xml", Parameters.CHARSET.entity("UTF-8"),
	...
	public void testHasParameter()
	{
		...
		assertFalse(new StructuredMediaType("Application", "xml", Parameters.CHARSET.entity("abcde")).hasParameter(Parameters.TITLE));
		assertTrue(new StructuredMediaType("Application", "xml", Parameters.TITLE.entity("123"), Parameters.CHARSET.entity("abcde"),
	...
	public void testToString()
	{
		...
		assertTrue("Application/xml;charset=\"UTF-8\"".equalsIgnoreCase(new StructuredMediaType("Application", "xml", "UTF-8").toString()));
	}
	...
	public void testEqualsObject()
	{
		...
		assertTrue(new StructuredMediaType("application", "xml").equals(new StringMediaType("Application/xml; charset=\"UTF-8\"")));
		...
		assertTrue(new StructuredMediaType("application", "xml").equals(new StructuredMediaType("application", "xml", "UTF-8")));
		assertTrue(new StructuredMediaType("application", "xml").equals(new StructuredMediaType("Application", "xml", "UTF-8")));
		assertFalse(new StructuredMediaType("application", "xml").equals(new StructuredMediaType("Application", "json", "UTF-8")));
		...
		assertTrue(new StructuredMediaType("application", "xml").equals(new StructuredMediaType("Application", "xml")));
		assertFalse(new StructuredMediaType("application", "xml").equals(new StructuredMediaType("Application", "json")));
